...
function produk($query, $userId){
	...
	if ($query == null){
		$result = new TextMessageBuilder("Keyword command yang satu ini bisa memberitahumu bahwa suatu produk itu bersertifikat halal dari MUI atau tidak.\n\nCara menggunakannya?\nKetik: .produk [nama produk]\nContoh: .produk abc\n\nSilahkan dicoba~ (((o(*ﾟ▽ﾟ*)o)))");
	} else {
